...
export const {
    ...
    DASHBOARD_DEPARTURE, PERSONAS_ARRIVAL, EDIT_ARRIVAL, COMMUNITY_ARRIVAL, OPPORTUNITY_NOTIFICATION, PROPOSAL_NOTIFICATION, IPFS_PROVIDER, NEW_DONATION, NEW_EXIT, NEW_RAGE, NEW_DELEGATION, 
