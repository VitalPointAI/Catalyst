...
export default function CancelCommitmentProposalCard(props) {
        ...
        <Card raised={true} className={classes.card}>          
          ...
          <CardContent>
            <Grid container alignItems="center" justifyContent="space-evenly" style={{marginTop: '-20px'}}>
              ...
              <Grid item xs={12} sm={12} md={12} lg={12} xl={12} align="center" >
                <Typography variant="overline" align="center" style={{marginBottom: '10px'}}>Liberation Request</Typography><br></br>
