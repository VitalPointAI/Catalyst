...
export default function TributeProposalCard(props) {
  ...
  const {
    ...
    const [voteEnding, setVoteEnding] = useState(0)
    const [rageQuitEnding, setRageQuitEnding] = useState(0)
