...
export const NODE_URL = process.env.REACT_APP_NODE_URL || 'https://rpc.testnet.near.org'
...
class Wallet {
    ...
    ********************************/
    ...
    async recoverAccountSeedPhrase(seedPhrase, accountId, fromSeedPhraseRecovery = true) {
        ...
        if (!accountIds.length) {
            throw new WalletError('Cannot find matching public key', 'account.recoverAccount.personaErrorInvalidSeedPhrase', { publicKey })
        }
