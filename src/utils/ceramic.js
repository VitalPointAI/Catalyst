...
class Ceramic {
  ...
  async getSeed(account) {
    const secretKey = localStorage.getItem('catalyst:seed:'+account.accountId)
  ...
  async associateDID(accountId, contract, ceramic) {
    ...
    const cached = localStorage.getItem('neardid:' + accountId + ':')
      ...
      let did
        try {
            ...
            if(didPresent) {   
              ...
              localStorage.setItem('neardid:' + accountId + ':', did)
              return did
            }
        } catch (err) {
        ...
        if (ceramic.did.id) {
          try{
            ...
            localStorage.setItem('neardid:' + accountId + ':', ceramic.did.id)
